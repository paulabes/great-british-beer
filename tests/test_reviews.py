...
class ReviewModelTest(TestCase):
    ...
    def test_review_rating_range(self):
        ...
        # Test maximum rating with DIFFERENT user/beer to avoid IntegrityError
        # Create a new user
...
class BeerViewsTest(TestCase):
    ...
    def test_review_list_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Now we check for content because we fixed the template
        self.assertContains(response, 'I enjoyed this beer.')
...
class ReviewsIntegrationTest(TestCase):
    ...
    def test_complete_beer_review_flow(self):
        ...
        self.assertContains(review_list_response, 'fantastic IPA')
