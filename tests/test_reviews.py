...
class BeerFormsTest(TestCase):
    ...
    def test_beer_form_valid(self):
        ...
        brewery = Brewery.objects.create(name='Valid Brewery', slug='valid-brewery')
        category = Category.objects.create(name='Valid Category', slug='valid-category')
        form_data = {
            'name': 'Test Lager',
            'brewery': brewery.id,
    ...
    def test_beer_form_invalid_abv(self):
        ...
        brewery = Brewery.objects.create(name='Invalid ABV Brewery', slug='invalid-abv-brewery')
        category = Category.objects.create(name='Invalid ABV Category', slug='invalid-abv-category')
        form_data = {
            'name': 'Test Beer',
            'brewery': brewery.id,
            'category': category.id,
    ...
    def test_review_form_valid(self):
        ...
        brewery = Brewery.objects.create(name='Review Form Brewery', slug='review-form-brewery')
        category = Category.objects.create(name='Review Form Category', slug='review-form-category')
        beer = Beer.objects.create(name='Review Beer', brewery=brewery, category=category, abv=5.0)
...
class BeerViewsTest(TestCase):
    ...
    def test_beer_detail_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'Test Bitter')
        self.assertContains(response, self.brewery.name)
...
class ReviewsIntegrationTest(TestCase):
    ...
    def test_complete_beer_review_flow(self):
        ...
        brewery = Brewery.objects.create(name='Test Brewery', slug='test-brewery')
        ...
        # Step 6: Verify review appears in lists (need to approve it first for it to show up)
    ...
    def test_search_and_filter_functionality(self):
        ...
        category1 = Category.objects.create(name='IPA', slug='ipa')
        category2 = Category.objects.create(name='Stout', slug='stout')
    ...
    def test_user_review_permissions(self):
        ...
        # Note: review_edit view is not implemented yet in urls.py
        pass
