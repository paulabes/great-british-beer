...
class ReviewModelTest(TestCase):
    ...
    def test_review_rating_range(self):
        ...
        # Test maximum rating - Create a new user to avoid unique constraint
...
class ReviewsIntegrationTest(TestCase):
    ...
    def test_complete_beer_review_flow(self):
        ...
        # Need to approve review first since default is is_approved=False
    ...
    def test_user_review_permissions(self):
        ...
        # Assuming there is no edit view yet, or it's not named 'review_edit'
        # The prompt mentioned review editing is not implemented.
        # So we expect 404 or similar.
        pass
